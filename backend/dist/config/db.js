...
async function initSqliteSchemaAndSeed() {
  ...
  `);
    ...
    try {
        await runSql(`ALTER TABLE Tasks ADD COLUMN TaskType TEXT DEFAULT 'General'`);
    }
    catch { }
    try {
        await runSql(`ALTER TABLE Tasks ADD COLUMN ReminderDate TEXT`);
    }
    catch { }
    try {
        await runSql(`ALTER TABLE Tasks ADD COLUMN Remarks TEXT`);
    ...
    try {
        await runSql(`ALTER TABLE Tasks ADD COLUMN UpdatedBy INTEGER`);
    }
    catch { }
    try {
        await runSql(`ALTER TABLE UserCompany ADD COLUMN CreatedBy INTEGER`);
    }
    catch { }
    try {
        await runSql(`ALTER TABLE UserCompany ADD COLUMN UpdatedBy INTEGER`);
    }
    catch { }
    try {
        await runSql(`
